...
class ViewController: UIViewController {
    ...
    private func addObservers(){
        NotificationCenter.default.addObserver(self, selector: #selector(startAnimating), name:NSNotification.Name.UIApplication.willEnterForegroundNotification, object: nil)
    }
